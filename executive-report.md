...
- Regular reviews of access rights with the intention to promote lesser privileges [@saltzer1975]
...
This Data Protection Policy will outline some measures that are compliant with the UK Data Protection Act 2018 [@govuk2018] and UK GDPR [@eu2016] requirements.
...
The enforcement of this policy will help demonstrate to governments a strong commitment to ensuring the confidentiality, integrity, and availability of this data.
...
Integrating the specific security controls will be heavily influenced by the risks identified in the risk register (u2242090, 2024) from the risk assessment. Such an approach can confirm that resources and security efforts are coordinated to be efficiently focussed on mitigating the highest priority risks.
...
Attention to this Encryption Policy will allow for sensitive data to be protected at all times and enforce regulatory compliance.

## 2.5 Secure Configuration Policy

A secure configuration baseline is foundational for minimising the attack surface on the company's technical assets. The Secure Configuration Policy determines strict standards needed for securing technical assets to stop threat actors from exploiting weak configurations.
...
These IAM controls will span across the whole IT infrastructure landscape such as on-site system, cloud applications, and external third-party systems. It also fits in with the principle of least privilege [@saltzer1975].
...
Having multi-layered controls makes it harder when a malicious actor intends to penetrate defenses.
...
- Synchronisation with other control areas, such as incident response and vulnerability management
...
The controls here will help in providing strong protection against threats concerning data.
...
Aligning secure baseline configurations with industry standard recommendations will help in mitigating vulnerabilities.

# 4 Implementation approach

A practical implementation of the framework will require a deployment plan, change management processes, and defined responsibilities spanning the organisation. With this, the company can effectively adhere to the Information Security Framework.
